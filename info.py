...
API_ID = int(environ.get('API_ID', '26166682'))
API_HASH = environ.get('API_HASH', '3f7acce23d64cdeae98e9bf463d320e4')
BOT_TOKEN = environ.get('BOT_TOKEN', "7459698664:AAHzyPcu3mx3nS4EhW0-iJJfY7iOXXsQDqk")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6558098741').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6593610568').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ElectraOp:BGMI272@cluster0.fpvovfb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001800618763))
LAZY_GROUP_LOGS = int(environ.get('LAZY_GROUP_LOGS', -1002243136198))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'fn_network_back')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002243136198')).split()]
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','FNxOwner') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','fn_network_back') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','fn_network_back') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','LayDeveloperr')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "fn_movie_requests") #[ without @ ]
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '931aef0569ad5024e2828f6159fed35d48d11451')
...
DOWNLOAD_TEXT_URL = "https://t.me/FN_NETWORK_TUTORIAL/2"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/fn_network_back"
